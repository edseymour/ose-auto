...
if __name__ == "__main__":
    make_cert("/etc/origin/master/etcd.server", None, sys.argv[1], "DNS:" + sys.argv[1], "serverAuth")
    make_cert("/etc/origin/master/master.server", None, sys.argv[1], "DNS:" + sys.argv[1], "serverAuth")
    make_cert("/etc/origin/node/server", None, sys.argv[1], "DNS:" + sys.argv[1], "serverAuth")
    make_cert("/etc/origin/node/system:node:" + sys.argv[1], "system:nodes", sys.argv[1], None, "clientAuth")
